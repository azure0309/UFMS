<?php
	...
	UFMS)))",$db_charset);
	$stid = oci_parse($conn, "SELECT TRUNK_ID, TRUNK_IN, TRUNK_OUT, ISCHECKED_IN,TO_CHAR(TRUNK_DATE,'MM-DD-YYYY HH24:MI:SS') TRUNK_DATE, TRUNK_OUT_ATTEMPT, TRUNK_IN_ATTEMPT FROM OD_GENERAL_TRUNK WHERE ISCHECKED_IN = 'N' ORDER BY TRUNK_ID ASC");
	$data = array();
