...
//        'VALUES(:c_type, :callfrom, :callto, :pfx, :cpfx, :pcdn, :pt, to_date(:created_date, "DD-MM-YYYY HH24:MI:SS"))';
     ...
     $sql =    "INSERT INTO od_alert_cmd (status,type,callfrom,callto,pfx,cpfx,pcdn,pt,BLOCKED)
            VALUES (:id,:c_type, :callfrom, :callto, :pfx, :cpfx, :pcdn, :pt, to_date(:blocked_date, 'YYYY-MM-DD HH24:MI:SS'))";
