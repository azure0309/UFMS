...
<html>
    ...
    <head>
    <title>International Call rate Archive</title>
    <meta charset="utf-8" />
    ...
    <body>
        <script type="text/javascript" src="javascript/archive_page/datetime.js"></script>
        <script type="text/javascript" src="javascript/archive_page/drawchart.js"></script>
                    ...
                    <ul id="active-list" class="nav navbar-nav">
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="archive_od_chart.php">International Call Rate</a></li>
        ...
        <div class="container">
            <div class="row">
                <p>Заасан хугацаандах өдрөөр хайх</p>
                <div class="col-md-12">
                    <select class="form-control" id="graph-controller">
                        <option value="0" disabled selected>Select from Time Interval</option>
                        <option value="1">Daily</option>
                        <option value="2">Weekly</option>
                        <option value="3">Monthly</option>
                        <option value="4">Seasonally</option>
            ...
            <br/>
            <div class="row">
                <div id="container_archive_in" style="min-width: 500px; height: 400px; margin: 0 auto"></div>
            </div>
            <div class="row">
                <div id="container_archive_out" style="min-width: 500px; height: 400px; margin: 0 auto"></div>
            </div>
        </div>
    </body>
</html>