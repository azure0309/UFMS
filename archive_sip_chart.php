...
<html>
    ...
    <head>
    <title>Local Call Rate Archive</title>
    <meta charset="utf-8" />
    ...
    <body>
        <script type="text/javascript" src="javascript/sip_archive_page/datetime.js"></script>
        <script type="text/javascript" src="javascript/sip_archive_page/drawchart.js"></script>
                    ...
                    <ul id="active-list" class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li role="separator" class="divider"></li>
                                <li class="dropdown-header">History</li>
                                <li class="active"><a href="archive_sip_chart.php">Local Call Rate</a></li>
