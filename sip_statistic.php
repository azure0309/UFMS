...
<html>
    ...
    <head>
    <meta charset="utf-8" />   
    <title>Local Call Statictics</title>
    ...
    <body>
        <script type="text/javascript" src="javascript/sip_statistics_page/auto_complete.js"></script>
        <script type="text/javascript" src="javascript/sip_statistics_page/master.js"></script>
                    ...
                    <ul id="active-list" class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="sip_statistic.php">Local Call</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
